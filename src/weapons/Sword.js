export default class Sword {
  ...
  update(time, enemies){
    ...
    // Circular AOE attack is built directly into the hero sprite animation.
    ...
    for(const enemy of enemies){
      ...
      if(d <= this.radius){
        if(enemy.type === 'shield' && enemy.blockNext){
          ...
          // Build 2.0: the scene owns stagger/knockback so AI cannot overwrite it.
          if(enemy.body){
